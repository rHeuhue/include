...
BM_PhoenixSpawn( id )
{
	...
	if ( iPhoenixID != -1 )
	{
		...
		if ( iPhoenixID != id )
		{
			...
			client_print_color( id, print_team_default, "^4%s ^3%s ^1has revived you.", GAME_NAME, szCastername );
			client_print_color( iPhoenixID, print_team_default, "^4%s ^1You have revived ^3%s^1.", GAME_NAME, szSpawnerName );
		}
	}
