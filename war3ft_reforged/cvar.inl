...
new CVAR_wc3_loot_bonus_percent;
...
public CVAR_Init()
{
	...
	CVAR_wc3_loot_bonus_percent = register_cvar( "wc3_loot_bonus_percent","100");
	CVAR_wc3_loot_items_health = register_cvar( "wc3_loot_items_health","25");
