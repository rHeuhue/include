			...
			if ( random_float( 0.0, 1.0 ) <= p_hides[iSkillLevel-1] )
				{
					...
					{
						client_print_color( iVictim, print_team_default, "^4%s ^3You have blocked a grenade.", GAME_NAME );
...
public EVENT_PlayerInitialSpawn( id )
{
	...
	{
		client_print_color( id, print_team_default, "^4%s ^3WC3 Cheats are enabled on this server! Try typing /level10", GAME_NAME );
