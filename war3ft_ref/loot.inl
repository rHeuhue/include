					...
					if(bIsDropItems == 0)
					{
						...
						switch(random_num(0, 3))
						{
							case 0:
							{
								...
								new iNumHealth = random_num(1, 50);
							...
							{	
								...
								fShowMessagePickUpItem(idUserTouch,szShowMessageLoot,93,173,226,enArmor);
							...
							case 2:
							{
								...
								//new iBonusXP = XP_GivenByLevel( iLevel ) + 15;
								//XP_Give( idUserTouch, iBonusXP );
								
								new iBonusXP = random_num(1, 50);
								XP_Give( idUserTouch, iBonusXP );
							...
							case 3:
							{
								new LootBonusGold = random_num(1, 50);
								
								set_user_gold(idUserTouch, get_user_gold(idUserTouch) + LootBonusGold); 
							
								format(szShowMessageLoot, charsmax(szShowMessageLoot), "+G: %d",LootBonusGold);
								fShowMessagePickUpItem(idUserTouch,szShowMessageLoot,241,196,15,enOther);
