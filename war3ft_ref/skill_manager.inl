SM_Init()
{
	...
	g_SkillOwner[SKILL_NOVA					]	= RACE_CRYSTAL;
	g_SkillOwner[SKILL_BITE					]	= RACE_CRYSTAL;
	g_SkillOwner[SKILL_ARCANE				]	= RACE_CRYSTAL;
	g_SkillOwner[ULTIMATE_FIELD				]	= RACE_CRYSTAL;
	
	g_SkillOwner[SKILL_ROAR					]	= RACE_DRUID;
	g_SkillOwner[SKILL_CYCLONE				]	= RACE_DRUID;
	g_SkillOwner[SKILL_HIDES				]	= RACE_DRUID;
	g_SkillOwner[ULTIMATE_CROW				]	= RACE_DRUID;
	...
	g_SkillType[SKILL_NOVA					]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_BITE					]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_ARCANE				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_FIELD				]	= SKILL_TYPE_ULTIMATE;
	
	g_SkillType[SKILL_ROAR					]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_CYCLONE				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_HIDES					]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_CROW				]	= SKILL_TYPE_ULTIMATE;
	...
	g_SkillOrder[SKILL_NOVA					]	= SKILL_POS_1;
	g_SkillOrder[SKILL_BITE					]	= SKILL_POS_2;
	g_SkillOrder[SKILL_ARCANE				]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_FIELD				]	= SKILL_POS_4;
	
	g_SkillOrder[SKILL_ROAR					]	= SKILL_POS_1;
	g_SkillOrder[SKILL_CYCLONE				]	= SKILL_POS_2;
	g_SkillOrder[SKILL_HIDES				]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_CROW				]	= SKILL_POS_4;
...
SM_SetPlayerRace( id, iRace )
{
	...
	if ( iRace == RACE_CHAMELEON )
	{
			...
			if ( Polymorph_Player[id] )
			{
				
				g_bPlayerSkills[id][Polymorph_Skill_1[id]] = true;
				g_bPlayerSkills[id][Polymorph_Skill_2[id]] = true;
				g_bPlayerSkills[id][Polymorph_Skill_3[id]] = true;
				g_bPlayerSkills[id][Polymorph_Ultimate[id]] = true;
				g_bPlayerSkills[id][Polymorph_Passive[id]] = true;
...
SM_SkillSet( id, iSkillID )
{
	switch( iSkillID )
	{
		...
		case SKILL_ARCANE:					// Crystal Maiden's Arcane Aura
		{
			CM_MoneyWave( id );
		}
