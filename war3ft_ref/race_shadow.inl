...
public _SH_DrawSerpentWard( parm[5] )
{
	...
	if ( bWardBombCheck )
	{
		...
		{
			client_print( id, print_chat, "%s Ward removed, you can not have them near bombs or hostages.", GAME_NAME );
...
public _SH_ResetBigBadAttacker( id )
{
	...
	client_print( id, print_chat, "%s You can not damage players with Big Bad Voodoo.", GAME_NAME );
}