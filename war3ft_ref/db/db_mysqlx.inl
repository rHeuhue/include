...
MYSQLX_Save( id )
{
	...
	if ( !SQL_Execute( query ) )
	{
		client_print( id, print_chat, "%s Unable to save your XP, please contact a server administrator.", GAME_NAME );
...
MYSQLX_SetDataForRace( id )
{
	...
	if ( !SQL_Execute( query ) )
	{
		client_print( id, print_chat, "%s Unable to retrieve XP, please contact a server administrator.", GAME_NAME );
